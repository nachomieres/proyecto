...
public class EditorialVO {	
	...
	public EditorialVO(String nombre, List<LibroVO> libros) {
		super();	
		this.nombre = nombre;
		this.libros = libros;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + idEditorial;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EditorialVO other = (EditorialVO) obj;
	...
	public String toString() {
		return "EditorialVO [idEditorial=" + idEditorial + ", nombre=" + nombre + ", libros=" + libros + "]";
	}
